...
import { X, FileText, ExternalLink, CheckCircle, XCircle, Car, MapPin, Clock } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ width: 'min(540px, 100vw)', background: 'hsl(var(--card))', borderLeft: '1px solid hsl(var(--border))' }}
      >
        {/* Header */}
        ...
        <div className="flex-1 p-6 space-y-6">
          ...
          <section>
            ...
            <dl className="grid grid-cols-2 gap-3">
              <InfoRow label="Email" value={request.employee_email} />
              ...
              <InfoRow label="Work Package" value={request.work_package ?? '—'} />
          ...
          {request.route_legs && request.route_legs.length > 0 && (
            <section>
              ...
              {request.route_legs.map(leg => (
                <div key={leg.id} className="scch-card p-4 space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-1">
                    <div className="text-center">
                      ...
                      <p className="font-bold text-sm" style={{ color: 'var(--scch-green)' }}>
                        {leg.distance_km ? `${Number(leg.distance_km).toFixed(1)} km` : '—'}
                      </p>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                      ...
                      <p className="font-bold text-sm" style={{ color: leg.return_trip ? 'var(--scch-green)' : 'hsl(var(--muted-foreground))' }}>
                        {leg.return_trip ? 'Yes' : 'No'}
                      </p>
                    </div>
                  </div>
                </div>
